...
<ul>
    ...
    <li>
        ...
        делаются неосознанно, то есть или не зная, что факт уже изменился, или
        же создание остатка было выполнено ещё до изменения самого факта. Точный
...
<ol>
    <li>
        ...
        <ul>
            <li>
                В простом заголовке нужно указать только тему манделы. Напишите
                о новой версии описываемого вами факта с целью привлечения
                внимания тех, кто увидит новую версию впервые.
                <h4>Пример</h4>
            ...
            <li>
                В сложном заголовке присутствуют уже три поля: Что, Было, Стало.
                Они больше подходят для мандел, в которых что-то изменилось. В
                Что укажите, о чём идет речь. В Было - как вы помните предыдущую
    ...
    <li>
        ...
        является первоисточником, и раньше о ней нигде не упоминалось, то также
